...
- On the terminal run this command git clone `https://github.com/admirerbrown/myAwesome-Books-project`

- Go to the repository folder using command prompt cd `myAwesome-Books-project`
